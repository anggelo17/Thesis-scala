 ...
 */
class GraphqlOpt (g: Graph[TLabel], q: Graph[TLabel])
{
...
//   } // refineSearchSpace
      ...
      */
     def getNeighborProfile (graph: Graph[TLabel], u: Int) : MutableList [TLabel] =
     {
...
//       profileList.sorted                        // FIX: check if sorting is required
      ...
      */
     def getNeighbors (graph: Graph[TLabel], u : Int): SET [Int] =
     {
