...
{ 
     ...
     */
    def checkIsomorphisms (bijections: Set [Array [Int]], q: Graph[TLabel], g: Graph[TLabel]): Boolean =
    {
        for (psi <- bijections) {
     ...
     *  @param q    the query graph Q(U, D, k)
     */
    def checkLabels (psi: Array [Int], q: Graph[TLabel], g: Graph[TLabel]): Boolean =
    {
     ...
     *  @param q    the query graph Q(U, D, k)
     */
    def checkEdges (psi: Array [Int], q: Graph[TLabel], g: Graph[TLabel]): Boolean =
    {
