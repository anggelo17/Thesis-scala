...
import scalation.graphalytics.LabelType.TLabel
import scalation.graphalytics.mutable.GraphSim
...
object GraphMatcherTest extends App
{
    ...
    def testBijections (matcher: GraphMatcher[TLabel], name: String, answer: SET [Array [Int]])
    {
        println ("-------------------------------------------------------------------")
    ...
    def testMappings (matcher: GraphMatcher[TLabel], name: String, answer: Array [SET [Int]])
    {
        println ("-------------------------------------------------------------------")
    ...
    //testMappings (new GraphSim (g, q), "GraphSim2", correctSimpleResult)
    //testMappings (new GraphSim2(g, q),  "GraphSim",  correctSimpleResult)
